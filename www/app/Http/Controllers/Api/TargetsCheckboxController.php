...
use StartMeUp\Repositories\Eloquent\TargetsCheckboxRepository;
...
class TargetsCheckboxController extends Controller
{
    ...
    public function index()
    {
        ...
        // Laravel Eloquent
        list($targets, $paginator) = $this->_getCollectionAndPaginator(new TargetsCheckboxRepository());
    ...
    {
        // Laravel Eloquent
        $targetsRepository = new TargetsCheckboxRepository();
        $target = $targetsRepository->find($id);
        if (!$target) {
            return response()
                ->json($this->_getResponseDataMessageEntityDoesNotExistError('TargetCheckbox', $id))
    ...
    public function update(Request $request, $id)
    {
        ...
        $rules = $this->_getValidationRules(new UpdateTargetCheckboxRequest());
