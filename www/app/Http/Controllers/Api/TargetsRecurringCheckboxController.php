...
use StartMeUp\Http\Requests\UpdateTargetRecurringCheckboxRequest;
use StartMeUp\Repositories\Eloquent\TargetsRecurringCheckboxRepository;
use StartMeUp\Transformers\GenericTransformer;
use Validator;

class TargetsRecurringCheckboxController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        // Laravel Eloquent
        list($targets, $paginator) = $this->_getCollectionAndPaginator(new TargetsRecurringCheckboxRepository());
    ...
    {
        // Laravel Eloquent
        $targetsRepository = new TargetsRecurringCheckboxRepository();
    ...
    public function update(Request $request, $id)
    {
        ...
        $rules = $this->_getValidationRules(new UpdateTargetRecurringCheckboxRequest());
